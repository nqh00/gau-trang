...
TS_INACTIVITY_RESTART_SECONDS=120       # FFMPEG will be restarted and TS files deleted when PID and TS files exist, but no file is accessed by client for this number of seconds
